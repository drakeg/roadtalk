...
from app.db import Account, Base, ChannelMembership, ChannelSelection, Device, Session
...
def test_device_and_session_relationships_are_bidirectional() -> None:
    ...
    assert ChannelMembership.account.property.back_populates == "channel_memberships"
    assert ChannelSelection.account.property.back_populates == "channel_selection"
    assert ChannelSelection.channel.property.back_populates == "selections"
